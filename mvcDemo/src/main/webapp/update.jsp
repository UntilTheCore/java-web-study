...
<div class="container" style="width: 400px;">
  ...
  <form action="${pageContext.request.contextPath}/userUpdateServlet?id=${requestScope.user.id}" method="post">
    <div class="form-group">
      <label for="name">姓名：</label>
      <input type="text" class="form-control" id="name" name="name" readonly="readonly"
             value="${requestScope.user.name}" placeholder="请输入姓名"/>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="qq" value="${requestScope.user.qq}" placeholder="请输入QQ号码"/>
    </div>

    <div class="form-group">
      <label for="email">Email：</label>
      <input type="text" class="form-control" name="email" value="${requestScope.user.email}"
             placeholder="请输入邮箱地址"/>
    </div>
